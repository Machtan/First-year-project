            ...
            for (Road.Edge road : route) {
                ...
                if (!road.parent().name.equals(last)) {
                    if (!last.equals(wrongC)) {
                        ...
                        String turnDesc;
                   //     System.out.println("angle between " + lastRoad.parent().name + " and " + road.parent().name + " is " + calAngle(lastRoad, road));
                        if (calAngle(lastRoad, road) < 90 || calAngle(lastRoad, road) > 270) {
                        turnDesc = "Turn left onto";
                       } else if (calAngle(lastRoad, road) > 90 && calAngle(lastRoad, road) < 270) {
